...
.hello
  svg(width=800, height=450, viewBox="0 0 800 450")
    g.wrapper
      g.countries
        path.country(
          v-for="d, i in worldData",
          v-bind:d="geoPath(d)",
          v-bind:fill="'rgba(38, 50, 56, ' + i / worldData.length + ')'",
          stroke="#FFFFFF",
          strokeWidth=0.5
        )
      g.markers
        circle.marker(
          ...
          v-bind:cx="projection()(city.coordinates)[0]",
          v-bind:cy="projection()(city.coordinates)[1]",
          v-bind:r="city.population / 3000000",
          fill="#E91E63",
          stroke="#FFFFFF"
        )
</template>
